...
\begin{itemize}
 \item \texttt{match fields:} fields that compare packets in order to look fo sono i valori con cui i pacchetti vengono confrontati per cercare corrispondenze. Contengono la porta d'ingresso, l'intestazione del pacchetto,
